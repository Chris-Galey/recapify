...
from .views import RecapView, RecapDetailView, RecapSummaryView, RecapSummaryDetailView, RecapTranscriptView
...
urlpatterns = [
    ...
    path('<int:recap_id>/summaries/', RecapSummaryView.as_view(), name='recap-summary-list'),
